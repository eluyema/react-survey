...
const stage: SurveyStageData = {
  stageId: "12",
  slug: slugs.relationshipsWithAstrology.relationshipDecisionWithHeart,
  necessaryAttributes: ["zodiac"],
  possibleParentStages: ["8"],
  modifiableAttributes: [],
  text: "Based on our data, 49% of {Zodiac} people also make decisions with their heart. But don't worry, we'll consider that while creating your guidance plan.",
  footerText: "Nicosia, Cyprus",
  nextSlug: slugs.relationshipsWithAstrology.sendGaidancePlan,
};

const RelationshipWithHeart = () => {
...
export default RelationshipWithHeart;
